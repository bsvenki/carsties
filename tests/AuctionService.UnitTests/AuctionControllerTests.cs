...
public class AuctionControllerTests
{
    ...
    [Fact]
    public async Task GetAuctionById_WithValidGuid_ReturnAuctions()
    {
        // arrange
    ...
    {
        // arrange 
        //Returning only not found, no auction object
        //var auction = _fixture.Create<AuctionDto>();
    ...
    [Fact]
     public async Task CreateAuction_With_ReturnsNotFound()
    {
        // arrange 
        //Returning only not found, no auction object
